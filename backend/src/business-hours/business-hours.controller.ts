...
export class BusinessHoursController {
  ...
  bulkDelete(@Body() body: { ids: number[] }) {
    return this.businessHoursService.bulkDelete(body.ids);
  }

  @Post('bulk-update')
  bulkUpdate(@Body() body: { updates: Array<{ id: number; startTime: string; endTime: string }> }) {
    return this.businessHoursService.bulkUpdate(body.updates);
  }
}
